...
class Course(models.Model):
   ...
   # @api.multi
    ...
    _sql_constraints = [
            ...
            "The course title should not match the description"),
            ('name_unique',
            'UNIQUE(name)',
...
class Session(models.Model):
    ...
    taken_seats = fields.Float(string="Taken seat", compute='_taken_seats')
    end_date = fields.Date(string="End Date", store=True, compute='_get_end_date', inverse='_set_end_date')
    attendees_count = fields.Integer(string="Attendance Counter", compute='_get_attendees_count', store=True)
